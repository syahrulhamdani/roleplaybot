...
async def register_rtvi_services(
    rtvi: RTVIProcessor, user_aggregator: LLMUserContextAggregator
):
    ...
    rtvi_vad = RTVIService(
        ...
        options=[
            RTVIServiceOption(
                name="params", type="object", handler=config_vad_params_handler
            ),
        ],
    )
    ...
    rtvi_llm = RTVIService(
        ...
        options=[
            RTVIServiceOption(
                name="model", type="string", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
                name="temperature", type="number", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
                name="top_p", type="number", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
                name="top_k", type="number", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
                name="frequency_penalty",
                type="number",
                handler=config_llm_settings_handler,
            ),
            RTVIServiceOption(
            ...
            RTVIServiceOption(
                name="seed", type="number", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
                name="extra", type="object", handler=config_llm_settings_handler
            ),
            RTVIServiceOption(
    ...
    rtvi_tts = RTVIService(
        ...
        options=[
            RTVIServiceOption(
                name="model", type="string", handler=config_tts_settings_handler
            ),
            RTVIServiceOption(
                name="voice", type="string", handler=config_tts_settings_handler
            ),
            RTVIServiceOption(
                name="language", type="string", handler=config_tts_settings_handler
            ),
            RTVIServiceOption(
                name="text_filter", type="object", handler=config_tts_settings_handler
            ),
            RTVIServiceOption(
                name="speed", type="string", handler=config_tts_speed_handler
            ),
            RTVIServiceOption(
                name="emotion", type="array", handler=config_tts_emotion_handler
            ),
            RTVIServiceOption(
            ...
            RTVIServiceOption(
                name="stability", type="number", handler=config_tts_settings_handler
            ),
            RTVIServiceOption(
    ...
    rtvi_stt = RTVIService(
        ...
        options=[
            RTVIServiceOption(
                name="model", type="string", handler=config_stt_settings_handler
            ),
            RTVIServiceOption(
                name="language", type="string", handler=config_stt_settings_handler
            ),
        ],
    )
